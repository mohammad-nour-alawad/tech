...
<head>
    ...
    <link rel="stylesheet" href="<?php echo URL; ?>public/css/editProfileBody.css">
    <link rel="stylesheet" href="<?php echo URL; ?>public/css/table.css">
    <link rel="stylesheet" href="<?php echo URL; ?>public/css/subject.css">
    ...
    <link rel="stylesheet" href="<?php echo URL; ?>public/css/addAvailability.css">
    ...
    <header>
        <nav class="nav" id="nav" onscroll="light()">
            ...
            <!--
                <div class="search-bar-container">
                    <form action="" method="POST">
                        <div class="search">
                            <input type="text" name="search-term" class="searchTerm"
            ...
            <div class="sidebar">
                ...
                <a href="<?php echo URL; ?>notification"><span>NOTIFICAIONS</span> </a>
                <?php if ($_SESSION['user']->role=="teacher") { ?>
                <a href="<?php echo URL; ?>session"><span>SESSION REQUESTS</span> </a>
                <a href="<?php echo URL; ?>users/addNewCourse"><span>NEW COURSE</span> </a>
                <a href="<?php echo URL; ?>courses/myCourses"><span>MY COURSES</span> </a>
                <a href="<?php echo URL; ?>availability/newAvailability"><span>NEW AVAILABILITY</span> </a>
                <a href="<?php echo URL; ?>reviews"><span>ALL REVIEWS</span> </a>
                <?php }?>
                <?php if ($_SESSION['user']->role=="student") { ?>
                <a href="<?php echo URL; ?>courses/profileCourses"><span>COURSES</span> </a>
                <?php }
                    } else {
                ?>
